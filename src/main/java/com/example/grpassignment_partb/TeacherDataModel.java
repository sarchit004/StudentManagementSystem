...
public class TeacherDataModel {
    ...
    public TeacherDataModel(String col1, String col2, String col3, String col4, String col5, String col6) {
    ...
    public SimpleStringProperty teacherFullNameProperty() { return FullName; }
    public SimpleStringProperty teacherFacultyProperty() { return Faculty; }
    public SimpleStringProperty teacherPhoneNumberProperty() { return PhoneNumber; }
    public SimpleStringProperty teacherGenderProperty() { return Gender; }
    public SimpleStringProperty teacherEmailProperty() { return Email; }
    public SimpleStringProperty teacherPasswordProperty() { return Password; }
